export const tips = [
  ...
  "Paying off finance loans as fast as you can, this will cut down the amount of interest paid.",
  "Fig Tech offers a low cost way to begin building a positive credit history.",
  "In order to build and maintain a strong credit score: pay bills on time, make frequent payments and keep balances low.",
]
